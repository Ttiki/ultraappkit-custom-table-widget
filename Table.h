...
namespace UltraEngine
{
	...
	public:
		...
		friend ComboBox;
		friend shared_ptr<Widget> CreateTable(const int, const int, const int, const int, shared_ptr<Widget>, const TableStyle);
		//friend shared_ptr<Widget> CreateListBox(const int, const int, const int, const int, shared_ptr<Interface>, const ListBoxStyle);
	};

	extern shared_ptr<Widget> CreateTable(const int x, const int y, const int width, const int height, shared_ptr<Widget> parent, const TableStyle style = TABLESTYLE_DEFAULT);
